        ...
        <div className="flex items-center justify-center h-screen">
          ...
          <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
            ...
            <div className="flex justify-center mt-5 text-sm">
              <p className="text-gray-400">Atau bisa login menggunakan</p>
            </div>
            <div className="mt-5 flex justify-center gap-3">
              ...
              <Image
                ...
                height={24}
              />
              <a className="bg-gray-400 h-7 w-7 rounded-3xl text-center grayscale cursor-pointer hover:grayscale-0 scale-105 duration-300 ">
                ...
              </a>
            </div>
