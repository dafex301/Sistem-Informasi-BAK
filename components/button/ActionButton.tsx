...
export const DeleteButton = (props: IButtonWithHandler) => {
  return (
    <button
      ...
      onClick={() => props.setSelected(["delete", props.row])}
    >
      <svg
...
export const FileButton = (props: IButtonWithHandler) => {
  return (
    <button
      ...
      onClick={() => props.setSelected(["file", props.row])}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
...
export const VerifyButton = (props: IButtonWithHandler) => {
  return (
    <button
      ...
      onClick={() => props.setSelected(["approve", props.row])}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
...
export const DisposisiButton = (props: IButtonWithHandler) => {
  return (
    <button
      className="bg-green-500 text-white p-2 rounded-md hover:bg-green-700"
      onClick={() => props.setSelected(["disposisi", props.row])}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
...
export const RejectButton = (props: IButtonWithHandler) => {
  return (
    <button
      className="bg-red-500 text-white p-2 rounded-md hover:bg-red-700"
      onClick={() => props.setSelected(["reject", props.row])}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
