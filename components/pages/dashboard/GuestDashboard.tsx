...
export default function GuestDashboard(props: any) {
  // TODO AYG

  return (
    <>
      <div>
        Selamat datang pada halaman guest halaman persuratan BAK Undip. Silahkan
        pilih aksi yang hendak dilakukan berikut:
      </div>
      ...
      <div className="grid grid-cols-2 justify-items-center gap-6 pt-5">
        ...
        <Link href="/surat/track">
          <button className="rounded-lg bg-gray-200 hover:bg-gray-300 m-4 p-4 grid grid-cols-4 items-center">
            ...
            <div className=" col-span-3 flex flex-col items-center justify-center gap-1">
              <h1 className="font-semibold">Track Surat</h1>
              <p>
                Ini adalah opsi untuk melacak surat yang telah dikirimkan ke
