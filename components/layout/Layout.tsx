...
const peminjamanRoles = ["KBAK", "MK", "SM"];
              ...
              <div className="flex flex-col gap-8 mt-12 mx-2 text-gray-500">
                ...
                {staffRoles.includes(role) && (
                  <div>
                    ...
                    {role === "SBAK" && <SidebarMenu
                        href={"/sekretaris/surat/create"}
                        solidIcon={
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                    ...
                    {(role == "KBAK" || role == "MK" || role == "SBAK") && (
                      <SidebarMenu
                        href={"/staff/surat/monitoring"}
                        solidIcon={
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                ...
                {role === "UKM" && (
                  <div>
                    ...
                    <SidebarMenu
                      ...
                      solidIcon={
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            d="M19.5 21a3 3 0 003-3V9a3 3 0 00-3-3h-5.379a.75.75 0 01-.53-.22L11.47 3.66A2.25 2.25 0 009.879 3H4.5a3 3 0 00-3 3v12a3 3 0 003 3h15zm-4.75-10.5a.75.75 0 00-1.5 0v2.25H9a.75.75 0 000 1.5h2.25v2.25a.75.75 0 001.5 0v-2.25H15a.75.75 0 000-1.5h-2.25V10.5z"
                            clipRule="evenodd"
                          />
                        </svg>
                      }
                    ...
                    <p className="text-xs mx-3 mb-2 mt-5 text-gray-600">
                      Menu Surat
                    </p>
                    <SidebarMenu
                      href={"/surat/create"}
